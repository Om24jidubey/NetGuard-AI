...
export default function AlertCard({ alert, onExplain, onBlock }) {
      ...
      <div className="alert-right">
        ...
        {onBlock && (
          <button 
            ...
            style={{ background: "#e24b4a", color: "#fff", border: "none", marginLeft: "10px", padding: "6px 12px", fontSize: "0.85rem" }} 
